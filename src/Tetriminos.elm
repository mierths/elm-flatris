...
tetriminos =
    List.map
        ...
        , ( Color.rgb 109 197 180, [ ( 0, 0 ), ( 1, 0 ), ( 2, 0 ) ] )
        , ( Color.rgb 203 103 103, [ ( 0, 0 ), ( 1, 0 ), ( 1, 1 ) ] )
        , ( Color.rgb 151 167 139, [ ( 0, 1 ), ( 0, 0 ), ( 1, 0 ) ] )
        , ( Color.rgb 215 123 204, [ ( 0, 0 ), ( 1, 0 ) ] )
        , ( Color.rgb 186 186 186, [ ( 0, 0 ) ] )
        ]
